...
use quote::quote;
use syn::*;
use crate::{transform::transform_fn, closure::{into_closure, get_return_type, make_tuple_type}};

fn transform_func(_: bool, attrs: &mut Vec<Attribute>, sig: &mut Signature, block: Option<&mut Block>) -> Result<()> {
